  ...
  incidents: [
    {
      ...
      roleReasons:     ['Closest to scene', 'First aid certified'],
      ...
      responders: [
        { initials: 'JK', name: 'Jana K.',  role: 'First Aid Certified', status: 'en-route', eta: '~2 min',  task: 'Bringing first aid kit'       },
        { initials: 'LB', name: 'Lukas B.', role: 'Coworker',            status: 'arrived',  eta: 'Arrived', task: 'Providing shade & monitoring' },
      ],
    },
    {
      ...
      roleReasons:     ['Closest available responder'],
      victimConscious: true,
      vitals: [
      ...
      responders: [
        { initials: 'MR', name: 'Mia R.', role: 'Trained Volunteer', status: 'en-route', eta: '~4 min', task: 'Fetching water & umbrella' },
      ],
    },
    {
      victim:       { name: 'Lena S.', coords: [48.2031, 16.3465], status: 'critical' },
      distance:     '~60 m',
      role:            'Sole Responder',
      roleDesc:        'You are the only person available — provide immediate support',
      roleReasons:     ['Only available responder nearby'],
      victimConscious: true,
      checksCompleted: 0,
      vitals: [
        { label: 'Heart Rate',       badge: 'Critically Elevated', color: 'red', level: 4, value: '172 BPM', normal: '60–100 bpm'    },
        { label: 'Body Temperature', badge: 'Dangerously High',    color: 'red', level: 4, value: '39.6 °C', normal: '36.1–37.2 °C' },
      ],
      itemsToBring: ['Water bottle', 'Cooling pack', 'Shade cloth'],
      responders: [],
    },
